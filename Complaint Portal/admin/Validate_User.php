...
?>
    ...
    <img src="../Images/logo.jpg" alt="" width="90px" height="90px">
      ...
      <h5>VALIDATE USERS</h5>
      <br>
      <section>
        <form>
            <div class="input-group">
                <label for="filter">Filter <i class="fas fa-filter"></i></label>
                <select id="filter" name="filter">
                <option value="complaintId">first ten row</option>
                    <option value="complaintType">first twenty rows</option>    
            ...
            <div class="input-group">
              <form method="GET">
                ...
                <input type="text" id="search" name="complaintId" required>
      ...
      <div class="table-container">
          <table id="complaintTable">
              ...
              if(isset($_GET['complaintId'])) {
                  ...
                  $whereClause = "WHERE `Enroll_ID`='$complaintId'";
              } else {
                  $whereClause = ""; // Initialize with an empty string if complaintId is not set
              }

              $select = "SELECT * FROM `registrations` $whereClause";
              ...
              ?>
                ...
                <?php if($selectrun->num_rows > 0) {
                  ...
                  <?php } ?>
                  <td>
                      <a href="View_Valid_User.php?id=<?php echo $selectrow['Enroll_ID'];?>" class="fas fa-eye"> View</a>
                      <a href="Validate_User.php?delid=<?php echo $selectrow['Enroll_ID'];?>" class="action-icon delete">&#128465; Delete</a>
                  </td>
