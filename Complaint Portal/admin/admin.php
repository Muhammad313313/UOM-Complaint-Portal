...
<br>
  ...
  <?php
    ...
    ?>
  <div class="counterr" style="background-image: url('../Images/imagesrecord.jpg'); opacity: 0.6; padding: 80px 0px; margin: auto; width: 60%; height: 30px; color: #fff; font-weight: 800; display: flex; justify-content: center; align-items: center; flex-wrap: wrap;">
