...
<br>
    ...
    <div class="carousel" style="margin: auto; width: 90%; height: 500px;">
      ...
      <div class="carousel-container">
        <div class="carousel-item">
          <img class="carousel-img" src="Carasolue01.jpg" alt="Image 1">
        </div>
        <div class="carousel-item">
          <img class="carousel-img" src="Carasolue02.jpg" alt="Image 2">
        </div>
        <div class="carousel-item">
          <img class="carousel-img" src="Carasolue03.jpg" alt="Image 3">
        </div>
      </div>
    ...
    <div class="counterr" style="background-image: url('imagesrecord.jpg'); opacity: 0.6; padding: 8px; margin: auto; width: 80%;  color: #fff; font-weight: 800;"  >
    <?php
