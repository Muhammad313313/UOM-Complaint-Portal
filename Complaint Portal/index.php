...
<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        $data="SELECT * FROM registrations WHERE Enroll_ID='$username' AND password='$password' and STATUS = 1";
         $run=$mysqli->query($data);

        if (mysqli_num_rows($run)==1) {
            $row=$run->fetch_array();
            $_SESSION['userid']= $row['Enroll_ID'];
...
?>
    ...
    <div class="container">
        ...
        <h6>UOM COMPLAINT PORTAL USER LOGIN</h6>
        <BR>
        <form id="loginForm" action="" method="POST">
          <label for="username">Enroll_ID</label>
          ...
          <div class="options">
            ...
            <hr>
            <h6 style="text-align: center;">Need An Account ?</h6>
